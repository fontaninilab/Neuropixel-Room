...
if isempty(fieldnames(S))  % If settings file was an empty struct, populate struct with default settings
    ...
    S.GUI.SinWaveFreqLeft = 8000; % Frequency of left cue
    S.GUI.SinWaveFreqRight = 16000; % Frequency of right cue
    ...
    S.GUI.PunishSound = 0; % if 1, plays a white noise pulse on error. if 0, no sound is played.
