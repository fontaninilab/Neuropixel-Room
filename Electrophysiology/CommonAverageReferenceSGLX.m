% % function CommonAverageReferenceSGLX(MouseID, SessionID, badchanID)
...
cd(['D:\Neuropixel Data\' MouseID sep MouseID '_' SessionID '_g0'];
mkdir([MouseID '_' SessionID '_g0_CAR']);

apfilepath = ['D:\Neuropixel Data\' MouseID sep MouseID '_' SessionID '_g0' sep ...
    MouseID '_' SessionID '_g0_imec0' sep ...
    MouseID '_' SessionID '_g0_t0.imec.ap.bin'];
channelMapFile = 'neuropixPhase3B1_kilosortChanMap.mat';
imec = Neuropixel.ImecDataset(apfilepath, 'channelMap', channelMapFile);

imec.markBadChannels(276:385); %Mark channels to exclude 
...
cleanedPath = ['D:\Neuropixel Data\' MouseID sep MouseID '_' SessionID '_g0' sep ...
