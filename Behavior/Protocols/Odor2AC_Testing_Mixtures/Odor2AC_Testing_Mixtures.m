function Odor2AC_Testing_Mixtures
global BpodSystem
global port;
...
for currentTrial = 1:MaxTrials
    ...
    switch TrialTypes(currentTrial)
        ...
        case 3  % left trials; delivery of tastant from line 1
           % odorvalveID = 1;
            ...
            odoropen = 5; % serial message ['O' 2]
            odorclose = 6; % serial message ['C' 2]
        ...
        case 4  % right trials; delivery of tastant from line 2
          %  odorvalveID = 6;
            ...
            odoropen = 7; % serial message ['O' 5]
            odorclose = 8; % serial message ['C' 5]
    ...
    disp(['Trial# ' num2str(currentTrial) ' TrialType: ' num2str(TrialTypes(currentTrial)) ' valve: ' num2str(tastevalveID) ' valvetime: ' num2str(tastevalvetime) ])
