...
for currentTrial = 1:MaxTrials
    ...
    sma = AddState(sma, 'Name', 'VaccuumOff', ... 
        ...
        'OutputActions', {'ValveModule2', vacoff});
    ...
    switch TrialTypes(currentTrial) % with correction
          ...
          case 1 % left trials; only see whether animals lick left spout
              sma = AddState(sma, 'Name', 'WaitForLateralLicks', ... 
                  ...
                  'StateChangeConditions', {'Tup', 'Timeout_omit', 'AnalogIn1_1', leftAction},...
                  'OutputActions', {});
          case 2
              sma = AddState(sma, 'Name', 'WaitForLateralLicks', ...
                  'Timer', S.GUI.ResponseTime,...
                  'StateChangeConditions', {'Tup', 'Timeout_omit', 'AnalogIn1_2', rightAction},...
                  'OutputActions', {});
