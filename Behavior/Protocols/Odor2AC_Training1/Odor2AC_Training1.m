...
for currentTrial = 1:MaxTrials
    ...
    sma = AddState(sma, 'Name', 'OdorValveOff', ... %Open specific odor valve
    'Timer', 0.01,...
    'StateChangeConditions ', {'Tup', 'HoldCentral'},...
    'OutputActions', {'ValveModule2', odorclose, 'BNC1',0});

    % hold central
    sma = AddState(sma, 'Name', 'HoldCentral', ... 
    'Timer', 1,...
    'StateChangeConditions ', {'Tup', 'CentralBack'},...
    'OutputActions', {});
   
    % central back
    sma = AddState(sma, 'Name', 'CentralBack', ... 
